        ...
        <>
            {registerSuccess ? (
                ...
                <Paper component='form' onSubmit={handleSubmit(onSubmit)}
                    ...
                    <TextInput label='Nombre de usuario' control={control} name='displayName' />
                    <TextInput label='Contraseña' control={control} name='password' type='password' />
                    <Button
                        type='submit'
                        loading={isSubmitting}
                        disabled={!isValid || isSubmitting}
                        variant="contained"
                        size="large">Registrar</Button>
